...
//saat edit dipilih pindah ke halaman edit
                            ...
                            case 1:
                                ...
                                AlertDialog.Builder builderx = new AlertDialog.Builder(DaftarCatatanActivity.this);
                                builderx.setNeutralButton("Cancel", new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int which) {
                                        dialog.dismiss();
                                    }
                                });
...
// refreshh list view
                                        ambilData();
                                        Intent i = new Intent(getBaseContext(),DaftarCatatanActivity.class);
                                        startActivity(i);
                                        finish();
                                    }
                                });
        ...
        if (cur.getCount() > 0) {
            while (cur.isAfterLast() == false) {
                ...
                c.setTitle((cur.getString(
                        cur.getColumnIndexOrThrow(DBAdapter.TITLE_CATATAN))));
